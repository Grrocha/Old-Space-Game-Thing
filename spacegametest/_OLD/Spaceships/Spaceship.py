...
class spaceship(object):
    ...
    def __init__(self,hullclass,vel,rotvel,modules,mass,fuel,assist,position,rot,name,ssid, hasengine, totalthrust, maxfuel, FiringEngines, MovVector, TotalConsumption, totalmass, power, totalpower, PowerGen,PID, CargoVol, Cargo, Controlling, Owner):
